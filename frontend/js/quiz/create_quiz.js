...
window.onload = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
    var editQuesgroupId, quizIntro;
    return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    editQuesgroupId = parseInt($('#editid').val());
                    quizIntro = null;
                    _context.next = 4;
                    return layui.use('layedit', function () {
                ...
                case 4:
                    ...
                    document.getElementById('submit').onclick = function () {
                        ...
                        $.post('/quizApi/quiz', {
                            ...
                            quizJson: (0, _stringify2.default)(questionList) }, function (resp, stat) {
...
module.exports = !__webpack_require__(37) && !__webpack_require__(59)(function () {
